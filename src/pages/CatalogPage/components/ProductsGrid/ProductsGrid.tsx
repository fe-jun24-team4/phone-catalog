...
const perPageOptions = new Options<number>('Items on page', [
  {
    key: '8',
    value: 8,
  },
...
const sortByOptions = new Options<string>('Sort by', [
  {
    key: 'Newest',
    value: 'newest',
  },
...
export const ProductsGrid = () => {
  const [perPage, setPerPage] = useState(perPageOptions.initialOption?.value);
  ...
  return (
    <div className={cn(style.gridContainer)}>
      <FilterControls
        ...
        onPerPageChange={option => setPerPage(option.value)}
      />

      <div className={cn(style.paginatedGridContainer)}>
        <ProductsGridPage products={mockData.slice(0, 8)} />

        <div className={style.paginationControlsContainer}>
          <PaginationControls itemsCount={mockData.length} perPage={perPage} />
        </div>
      </div>
    </div>
  );
